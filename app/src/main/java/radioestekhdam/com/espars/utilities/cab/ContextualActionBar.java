...
public class ContextualActionBar implements Serializable, Toolbar.OnMenuItemClickListener {
    ...
    private boolean attach() {
        ...
        if (attacher instanceof ViewStub) {
            ...
            stub.setLayoutResource(R.layout.material_toolbar_with_textview);
            ...
            mToolbar = (Toolbar) LayoutInflater.from(mContext)
                    .inflate(R.layout.material_toolbar_with_textview, parent, false);
        ...
        titleTextView = mToolbar.findViewById(R.id.toolBarTitle);
        if (mToolbar != null) {
            if (mTitle != null)
                setTitle(mTitle);
            if (mPopupTheme != 0)
